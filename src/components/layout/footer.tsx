...
export function Footer() {
  ...
  return (
    <footer className="mx-2 sm:mx-4 lg:mx-10 mb-2 sm:mb-4 rounded-t-xl sm:rounded-t-2xl lg:rounded-t-3xl bg-black text-white relative overflow-hidden">
       ...
       <div className="absolute bg-white z-10 -top-2 sm:-top-4 lg:-top-4 -right-6 sm:-right-1 rounded-xl sm:rounded-2xl lg:rounded-3xl p-1 sm:p-2 w-32 sm:w-64 lg:w-96 xl:w-[650px] h-6 sm:h-8 lg:h-12 xl:h-16 hidden lg:block text-brand-ink text-center pt-6"><span className="relative top-4">Shit I’ve gone too far, send me back up</span></div>
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-20 py-6 sm:py-20 md:py-10 lg:py-14">
        ...
        <div className="border-t border-gray-800 pt-4 sm:pt-6 md:pt-8">
          ...
          {/* Copyright section */}
          <div className="flex sm:flex-row lg:flex-row justify-between gap-2 items-start sm:items-center pt-4 sm:pt-6 border-t border-gray-800 text-xs sm:text-sm text-gray-400  sm:gap-4">
            <div className="flex ">
