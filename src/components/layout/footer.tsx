       ...
       <div className="absolute flex justify-between items-center bg-white z-10 -top-1 text-[1.8rem] border-transparent sm:-top-4 lg:-top-4 -right-6 sm:-right-1 rounded-xl sm:rounded-2xl lg:rounded-3xl p-1 sm:p-2 w-32 sm:w-64 lg:w-96 xl:w-[650px] h-7 sm:h-8 lg:h-14 xl:h-20 font-black lg:block text-brand-ink text-center pt-6"><span className="relative top-4 right-6">Sh* I’ve Gone Too Far, Send Me Back Up</span><img src="public\footer-hand.png" alt="footer-hand" className="relative left-[30vw] bottom-[1vw] w-6 h-6" /></div>
        ...
        <div className="absolute bg-white z-20 -top-1 sm:-top-2 lg:-top-4  lg:-left-4 sm:-left-2 rounded-lg sm:rounded-xl portfoliolg:rounded-2xl xl:rounded-3xl p-1 sm:p-2">
          <div className="flex lg:flex-col items-center lg:items-start gap-1 sm:gap-2 lg:gap-3 xl:gap-5 p-1 sm:p-2">
            <a href="#" aria-label="Facebook" className="grid h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 place-items-center rounded-full bg-brand-purple hover:bg-brand-purple transition-colors">
              <Facebook className="h-2.5 w-2.5 sm:h-3 sm:w-3 lg:h-4 lg:w-4 xl:h-6 xl:w-6 text-white" />
            </a>
            <a href="#" aria-label="Instagram" className="grid h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 place-items-center rounded-full bg-brand-purple hover:bg-brand-purple transition-colors">
              <Instagram className="h-2.5 w-2.5 sm:h-3 sm:w-3 lg:h-4 lg:w-4 xl:h-6 xl:w-6 text-white" />
            </a>
            <a href="#" aria-label="Twitter/X" className="grid h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 place-items-center rounded-full bg-brand-purple hover:bg-brand-purple transition-colors">
              <X className="h-2.5 w-2.5 sm:h-3 sm:w-3 lg:h-4 lg:w-4 xl:h-6 xl:w-6 text-white" />
            </a>
            <a href="#" aria-label="LinkedIn" className="grid h-6 w-6 sm:h-8 sm:w-8 lg:h-10 lg:w-10 xl:h-12 xl:w-12 place-items-center rounded-full bg-brand-purple hover:bg-brand-purple transition-colors">
        ...
        <div className="mb-6 sm:mb-8 sm:mt-20 md:mb-10 lg:mb-12">
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-10">
            ...
            <div className="sm:col-span-2 lg:col-span-1 space-y-3 sm:space-y-4  md:mt-[2vw] ">
              ...
              <div className="space-y-3 sm:space-y-4 lg:space-y-5" style={{ color: '#696969' }}>
        ...
        <div className=" w-full absolute bottom-0 left-0 pt-4 sm:pt-6 md:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 sm:gap-6 mb-4 sm:mb-6 border-white/40 border-b pb-10 px-20">
            <div className="w-full md:w-auto">
              <h2 className="text-base sm:text-2xl md:text-6xl lg:text-7xl xl:text-[5rem] text-white font-bold font-rf-dewi">Where Quotes Meet Purpose.</h2>
            </div>
            <div className="hidden md:flex items-center relative right-40 top-6 transform -translate-y-[35%]">
                                  ...
                                  <img src="/Arrow 1-1.svg" alt="arrow" className="p-[18px] rounded-full bg-lime-300 text-brand-ink absolute left-[9vw]" />
                                </div>
          </div>
          ...
          <div className="flex w-full sm:flex-row lg:flex-row justify-between gap-2 items-start sm:items-center pb-6 text-xs sm:text-sm text-white sm:gap-4 px-20">
            <div className="flex ">
              <span className="w-36"><img src="/SwanLogics-logo-black.png" alt="" /></span>
              
            </div>
            <div className="flex flex-col sm:flex-row gap-2 text-center sm:text-left">
              <span className="whitespace-nowrap text-base sm:text-base sm:pr-5 lg:pr-10">© Mercury Sole Ltd 2025</span>
              <span className="whitespace-nowrap text-base sm:text-base  border-l-[1px] border-[#d0ff7194] sm:px-5 lg:px-10">Web Design Manchester</span>
            <span className="whitespace-nowrap text-base sm:text-base  mt-2 sm:mt-0 border-l-[1px] border-[#d0ff7194] sm:pl-5 lg:pl-10">All Rights Reserved</span>
            </div>
          </div>
        </div>
      </div>
