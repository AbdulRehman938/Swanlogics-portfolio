    ...
    <section id="home" className="w-full bg-white">
      <div className="relative mx-auto max-w-[1400px] px-4 pb-8 pt-8 sm:px-6 sm:pb-12 sm:pt-10 md:px-10 md:pt-16">
        ...
        <div className="relative mt-4 sm:mt-8">
          ...
          <div className="hidden sm:flex gap-4 md:gap-6 lg:gap-14 mb-2 relative top-8 sm:top-12 md:top-16 lg:top-24 left-4 sm:left-8 md:left-32 lg:left-56">
            <a
              href="#projects"
            ...
            >
              <span className="font-dewi text-xs sm:text-sm md:text-base text-brand-ink px-2 sm:px-3 md:px-4 lg:px-6">
                Meet The Team
              </span>
